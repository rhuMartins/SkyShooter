...
from code.Const import WINDOW_HEIGHT, COLOR_WHITE, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME
...
class Level:
    ...
    def run(self):
        ...
        while True:
            ...
            self.level_text(14, f'entidade: {len(self.entity_list)}', COLOR_WHITE, (10, WINDOW_HEIGHT - 20))
            pygame.display.flip()
