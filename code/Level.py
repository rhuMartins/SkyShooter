...
from code.Const import WINDOW_HEIGHT, C_WHITE, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, C_GREEN, C_CYAN, C_BLACK
...
class Level:
    ...
    def run(self):
        ...
        while True:
            ...
            self.level_text(14, f'entidade: {len(self.entity_list)}', C_WHITE, (10, WINDOW_HEIGHT - 20))
            pygame.display.flip()
